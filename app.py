...
class TodoList(db.Model):
  ...
  def __repr__(self):
    return f'<Todo {self.id} {self.name} {self.todos}>'
...
def get_list_todos(list_id):
  ...
  lists=TodoList.query.all(), active_list=TodoList.query.get(list_id), todos=Todo.query.filter_by(list_id=list_id).order_by('id').all())
